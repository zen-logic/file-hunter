...
const icons = {
    ...
    /* Eye — similarity search */
    eye: svg(
        '<path d="M12 4.5C7 4.5 2.73 7.61 1 12c1.73 4.39 6 7.5 11 7.5s9.27-3.11 11-7.5c-1.73-4.39-6-7.5-11-7.5zm0 12.5c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm0-8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"/>'
    ),

    /* Document with magnifying glass — content search */
    contentSearch: svg(
        '<path d="M6 2a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h7.17a6 6 0 0 1-.17-1.5 6 6 0 0 1 6-6c.52 0 1.02.07 1.5.17V8l-6-6H6zm2 9h8v1.5H8V11zm0 4h4v1.5H8V15z"/>' +
        '<circle cx="17.5" cy="18.5" r="2.5" fill="none" stroke="currentColor" stroke-width="1.5"/>' +
        '<line x1="19.5" y1="20.5" x2="22" y2="23" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>'
    ),
