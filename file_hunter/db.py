...
_MIGRATIONS = [
    ...
    "ALTER TABLE folders ADD COLUMN stale INTEGER NOT NULL DEFAULT 0",
    "ALTER TABLE locations ADD COLUMN is_favourite INTEGER NOT NULL DEFAULT 0",
    "ALTER TABLE folders ADD COLUMN is_favourite INTEGER NOT NULL DEFAULT 0",
]
